...
public static class ModHelperData
{
    ...
    public const string Name = "EeveeFourthPath";

    public const string Description = "Adds a fourth path based on Sylveon and a Paragon to Allonischmoni's Eevee tower";
